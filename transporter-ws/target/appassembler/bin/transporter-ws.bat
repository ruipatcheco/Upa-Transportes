...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="transporter-ws" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.upa.transporter.TransporterApplication %CMD_LINE_ARGS%
