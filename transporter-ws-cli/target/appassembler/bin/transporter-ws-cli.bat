...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="transporter-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.upa.transporter.TransporterClientApplication %CMD_LINE_ARGS%
