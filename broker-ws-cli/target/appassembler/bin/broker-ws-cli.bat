...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="broker-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.upa.broker.BrokerClientApplication %CMD_LINE_ARGS%
